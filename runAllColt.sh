...
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw1chain.yaml -s inputs/sources/source5.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw1chain.yaml -s inputs/sources/source6.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw1chain.yaml -s inputs/sources/source7.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw1chain.yaml -s inputs/sources/source8.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw1chain.yaml -s inputs/sources/source9.yaml -c 100
...
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw2chain.yaml -s inputs/sources/source5.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw2chain.yaml -s inputs/sources/source6.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw2chain.yaml -s inputs/sources/source7.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw2chain.yaml -s inputs/sources/source8.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw2chain.yaml -s inputs/sources/source9.yaml -c 100
...
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw3chain.yaml -s inputs/sources/source5.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw3chain.yaml -s inputs/sources/source6.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw3chain.yaml -s inputs/sources/source7.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw3chain.yaml -s inputs/sources/source8.yaml -c 100
./place-emu.sh -n inputs/networks/Colt.graphml -t inputs/services/fw3chain.yaml -s inputs/sources/source9.yaml -c 100
